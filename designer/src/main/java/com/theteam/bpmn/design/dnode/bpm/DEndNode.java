 ...
 */
public class DEndNode extends DNode implements IDrawable
{
    DrawMethod dm;

    public DEndNode(NodeHeader header, Tooltip tooltip, VBox inputs, VBox outputs, DrawMethod dm, Boolean drawNode)
    {
